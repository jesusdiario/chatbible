          ...
          <div className="bg-token-sidebar-surface-primary pt-0">
            ...
            <div className="mt-4 flex flex-col gap-4">
              {timeframes.map(timeframe => <div key={timeframe.title}>
                  ...
                  {timeframe.items.map(item => <div key={item} className="group flex h-10 items-center gap-2.5 rounded-lg px-2 hover:bg-token-sidebar-surface-secondary cursor-pointer">
