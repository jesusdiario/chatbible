...
import { Home, Book, Search, MoreHorizontal, ChevronLeft, ChevronRight } from 'lucide-react';
...
export const BibleFooter: React.FC<BibleFooterProps> = ({
  ...
  return <div className="fixed bottom-0 left-0 right-0 bg-white border-t">
      <div className="flex justify-between items-center px-4 py-2">
        ...
        <Button variant="ghost" className="flex-1 font-medium" onClick={onOpenBooksNav}>
          {bookName} {chapter}
        </Button>
